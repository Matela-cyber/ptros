      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold text-blue-800">PTROS Carrier</h1>
          </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-yellow-700 mt-1">
                Carrier accounts require coordinator approval. You will receive
                SMS notification once approved.
              </p>
            </div>
          </div>
        </div>
